...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {
      name: "sub_expression$subexpression$1",
      symbols: ["identifier"],
      postprocess: id,
    },
    {
      name: "sub_expression$subexpression$1",
      symbols: ["multi_select_list"],
      postprocess: id,
    },
    {
      name: "sub_expression$subexpression$1",
      symbols: ["multi_select_hash"],
      postprocess: id,
    },
    {
      name: "sub_expression$subexpression$1",
    ...
    },
    {
      ...
      symbols: [
        ...
        { literal: "." },
        "_",
        "sub_expression$subexpression$1",
      ],
      postprocess: (d) => ({ type: "sub_exp", exp: d[0], val: d[4] }),
    },
    {
      name: "pipe_expression",
      symbols: ["expression", "_", { literal: "|" }, "_", "expression"],
      postprocess: (d) => ({ type: "pipe_exp", lhexp: d[0], rhexp: d[4] }),
    },
    {
      name: "or_expression$string$1",
      symbols: [{ literal: "|" }, { literal: "|" }],
      postprocess: (d) => d.join(""),
    },
    {
      name: "or_expression",
      symbols: ["expression", "_", "or_expression$string$1", "_", "expression"],
      postprocess: (d) => ({ type: "or_exp", lhexp: d[0], rhexp: d[4] }),
    },
    {
      name: "and_expression$string$1",
      symbols: [{ literal: "&" }, { literal: "&" }],
      postprocess: (d) => d.join(""),
    },
    {
      ...
      symbols: [
        "expression",
        "_",
        "and_expression$string$1",
        "_",
        "expression",
      ],
      postprocess: (d) => ({ type: "and_exp", lhexp: d[0], rhexp: d[4] }),
    },
    {
      name: "not_expression",
      symbols: [{ literal: "!" }, "_", "expression"],
      postprocess: (d) => ({ type: "not_exp", exp: d[2] }),
    },
    {
      name: "paren_expression",
      symbols: [{ literal: "(" }, "_", "expression", "_", { literal: ")" }],
      postprocess: (d) => ({ type: "paren_exp", exp: d[2] }),
    },
    {
      name: "index_expression",
      symbols: ["expression", "_", "bracket_specifier"],
      postprocess: (d) => ({ type: "index_exp", exp: d[0], child: d[2] }),
    },
    { name: "bracket_specifier$subexpression$1", symbols: ["number"] },
    { name: "bracket_specifier$subexpression$1", symbols: ["wildcard"] },
    {
      name: "bracket_specifier$subexpression$1",
      symbols: ["slice_expression"],
    },
    {
      name: "bracket_specifier",
      symbols: [
        { literal: "[" },
        "_",
        "bracket_specifier$subexpression$1",
        "_",
        { literal: "]" },
      ],
      postprocess: (d) => d[2][0],
    ...
    },
    {
      ...
      postprocess: (d) => ({ type: "optional_index", exp: d[4] }),
    },
    { name: "multi_select_list$ebnf$1", symbols: [] },
    {
      name: "multi_select_list$ebnf$1$subexpression$1",
      symbols: ["_", { literal: "," }, "_", "expression"],
    },
    {
      name: "multi_select_list$ebnf$1",
      symbols: [
        "multi_select_list$ebnf$1",
        "multi_select_list$ebnf$1$subexpression$1",
      ],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
    ...
    {
      name: "multi_select_hash$ebnf$1$subexpression$1",
      symbols: ["_", { literal: "," }, "_", "keyval_expr"],
    },
    {
      name: "multi_select_hash$ebnf$1",
      symbols: [
        "multi_select_hash$ebnf$1",
        "multi_select_hash$ebnf$1$subexpression$1",
      ],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
      name: "multi_select_hash",
      symbols: [
        { literal: "{" },
        "_",
        "keyval_expr",
    ...
    },
    {
      ...
      postprocess: (d) => ({ type: "keyval_exp", key: d[0], val: d[4] }),
    },
    ...
    {
      name: "slice_expression$ebnf$3$subexpression$1$ebnf$1",
      symbols: ["number"],
      postprocess: id,
    },
    {
    ...
    {
      name: "slice_expression$ebnf$3$subexpression$1",
      symbols: [
        "_",
        { literal: ":" },
        "_",
        "slice_expression$ebnf$3$subexpression$1$ebnf$1",
      ],
    },
    {
      name: "slice_expression$ebnf$3",
      symbols: ["slice_expression$ebnf$3$subexpression$1"],
      postprocess: id,
    },
    { name: "slice_expression$ebnf$3", symbols: [], postprocess: () => null },
    {
      ...
      symbols: [
        "slice_expression$ebnf$1",
        "_",
        { literal: ":" },
        "_",
        "slice_expression$ebnf$2",
        "slice_expression$ebnf$3",
      ],
      postprocess: (d) => {
    ...
    {
      name: "comparator_expression",
      symbols: ["expression", "_", "comparator", "_", "expression"],
      postprocess: (d) => ({
        type: "compare_exp",
        comparator: d[2],
        lhexp: d[0],
    ...
    {
      name: "function_expression$subexpression$1",
      symbols: ["one_or_more_args"],
    },
    {
      name: "function_expression",
      symbols: ["function_name", "_", "function_expression$subexpression$1"],
      postprocess: (d) => ({
        type: "func_exp",
        identifier: d[0],
        args: d[2][0],
    ...
    {
      name: "one_or_more_args$ebnf$1$subexpression$1",
      symbols: ["_", { literal: "," }, "_", "function_arg"],
    },
    {
      name: "one_or_more_args$ebnf$1",
      symbols: [
        "one_or_more_args$ebnf$1",
        "one_or_more_args$ebnf$1$subexpression$1",
      ],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
      name: "one_or_more_args",
      symbols: [
        { literal: "(" },
        "_",
        "function_arg",
    ...
    },
    {
      name: "function_arg",
      symbols: ["expression"],
      postprocess: position((d) => ({ type: "func_arg", exp: d[0] })),
    },
    {
      name: "function_arg",
      symbols: ["expression_type"],
      postprocess: position((d) => ({ type: "func_arg", exp: d[0] })),
    },
    {
      name: "expression_type",
      symbols: [{ literal: "&" }, "_", "expression"],
      postprocess: (d) => ({ type: "expr_type", expr: d[2] }),
    },
    {
      name: "current_node",
      symbols: [{ literal: "@" }],
      postprocess: () => ({ type: "current_node" }),
    },
    ...
    { name: "identifier", symbols: ["quoted_string"], postprocess: id },
    {
      name: "wildcard",
      symbols: [{ literal: "*" }],
      postprocess: position(([value]) => ({ type: "wildcard", value })),
    },
    {
      name: "number",
      symbols: ["jsonfloat"],
      postprocess: position(([value]) => ({ type: "number", value })),
    },
    {
      name: "raw_string",
      symbols: ["sqstring"],
      postprocess: position(([value]) => ({ type: "raw_string", value })),
    },
    {
      name: "literal",
      symbols: ["btstring"],
      postprocess: position(([value]) => ({ type: "literal", value })),
    },
    {
      name: "quoted_string",
      symbols: ["dqstring"],
      postprocess: position(([value]) => ({ type: "quoted_string", value })),
    },
    ...
    {
      name: "unquoted_string$ebnf$1",
      symbols: ["unquoted_string$ebnf$1", "letter_or_digit"],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
      name: "unquoted_string",
      symbols: ["letter", "unquoted_string$ebnf$1"],
      postprocess: position((d) => ({
        type: "unquoted_string",
        value: d[0] + (d[1] as unknown as string[]).join(""),
      })),
    },
    {
      name: "json_value$string$1",
      symbols: [
        { literal: "f" },
        { literal: "a" },
        { literal: "l" },
    ...
    {
      name: "json_value",
      symbols: ["json_value$string$1"],
      postprocess: () => false,
    },
    {
      name: "json_value$string$2",
      symbols: [
        { literal: "n" },
        { literal: "u" },
        { literal: "l" },
    ...
    {
      name: "json_value",
      symbols: ["json_value$string$2"],
      postprocess: () => null,
    },
    {
      name: "json_value$string$3",
      symbols: [
        { literal: "t" },
        { literal: "r" },
        { literal: "u" },
    ...
    {
      name: "json_value",
      symbols: ["json_quoted_string"],
      postprocess: (d) => d[0],
    },
    { name: "json_quoted_string", symbols: ["quoted_string"], postprocess: id },
    { name: "json_object$ebnf$1$subexpression$1$ebnf$1", symbols: [] },
    {
      name: "json_object$ebnf$1$subexpression$1$ebnf$1$subexpression$1",
      symbols: ["_", { literal: "," }, "_", "member"],
    },
    {
      name: "json_object$ebnf$1$subexpression$1$ebnf$1",
      symbols: [
        "json_object$ebnf$1$subexpression$1$ebnf$1",
        "json_object$ebnf$1$subexpression$1$ebnf$1$subexpression$1",
      ],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
      name: "json_object$ebnf$1$subexpression$1",
      symbols: ["member", "json_object$ebnf$1$subexpression$1$ebnf$1"],
    },
    {
      name: "json_object$ebnf$1",
      symbols: ["json_object$ebnf$1$subexpression$1"],
      postprocess: id,
    },
    { name: "json_object$ebnf$1", symbols: [], postprocess: () => null },
    {
      ...
      postprocess: (d) => ({
        type: "json_object",
        val: d[2]
          ? [d[2][0], ...d[2][1].map((r: Types.Expression[]) => r[3])]
          : [],
      }),
    },
    {
      name: "member",
      symbols: ["quoted_string", "_", { literal: ":" }, "_", "json_value"],
    },
    { name: "json_array$ebnf$1$subexpression$1$ebnf$1", symbols: [] },
    {
      name: "json_array$ebnf$1$subexpression$1$ebnf$1$subexpression$1",
      symbols: ["_", { literal: "," }, "_", "json_value"],
    },
    {
      name: "json_array$ebnf$1$subexpression$1$ebnf$1",
      symbols: [
        "json_array$ebnf$1$subexpression$1$ebnf$1",
        "json_array$ebnf$1$subexpression$1$ebnf$1$subexpression$1",
      ],
      postprocess: (d) => d[0].concat([d[1]]),
    },
    {
      name: "json_array$ebnf$1$subexpression$1",
      symbols: ["json_value", "json_array$ebnf$1$subexpression$1$ebnf$1"],
    },
    {
      name: "json_array$ebnf$1",
      symbols: ["json_array$ebnf$1$subexpression$1"],
      postprocess: id,
    },
    { name: "json_array$ebnf$1", symbols: [], postprocess: () => null },
    {
      ...
      postprocess: (d) =>
        d[2] ? [d[2][0], ...d[2][1].map((r: Types.Expression[]) => r[3])] : [],
    },
  ],
  ParserStart: "main",
};
